...
// let data1 = '값 수정중';//SyntaxError: Identifier 'data1' has already been declared

// console.log(data2, typeof(data2));//ReferenceError: Cannot access 'data2' before initialization
let data2 = "let 변수 두번째";

//호이스팅은 자바스크립트에서 변수와 함수 선언을 코드의 최상단으로 끌어올리는 것을 의미한다
//코드를 실행하기 전에 변수, 함수 등의 선언이 메모리에 저장되기 때문에 가능하다

//var로 선언된 변수는 선언과 동시에 undefined 로 초기화 된고 이후에 실제 값으로 할당된다
