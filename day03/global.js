...
function changeNumber(num1, num2){
  globalThis.num = num1;//globalThis를 통해 전역변수 num 을 num1값으로 설정
  console.log(globalThis.num);
...
// 코드의 이식성이 떨어지는 것을 극복하기 위해 도입된 표준화된 방법
//(ES11에서 도입된 표준 객체)
...
console.log(globalThis.str);//전역객체에 변수를 설정할 수 있고 함수 밖에서도 접근 가능